...
const i18n = {
    'zh':    { acorns:'橡子',    gems:'靈石',   lvl:'老闆Lv',  modeBuild:'🔨 建造/升級', modeDemolish:'🧨 拆除',     btnLang:'🌐 繁中',    btnDex:'📖 圖鑑', btnShop:'🛒 商店', btnRoster:'🎒 隊伍', btnFriend:'🤝 好友', btnSettings:'⚙️ 設定', btnCancel:'🚫 取消', btnExpand:'📜 購新地', shopTitle:'精品商店', buy:'購買', msgUnlock:'✨ 解鎖！', timeAuto:'🕐 同步', timeDay:'☀️ 白天', timeNight:'🌙 夜晚' },
    'zh-CN': { acorns:'橡子',    gems:'灵石',   lvl:'老板Lv',  modeBuild:'🔨 建造/升级', modeDemolish:'🧨 拆除',     btnLang:'🌐 简中',    btnDex:'📖 图鉴', btnShop:'🛒 商店', btnRoster:'🎒 队伍', btnFriend:'🤝 好友', btnSettings:'⚙️ 设置', btnCancel:'🚫 取消', btnExpand:'📜 购新地', shopTitle:'精品商店', buy:'购买', msgUnlock:'✨ 解锁！', timeAuto:'🕐 同步', timeDay:'☀️ 白天', timeNight:'🌙 夜晚' },
    'ja':    { acorns:'どんぐり', gems:'霊石',   lvl:'ボスLv',  modeBuild:'🔨 建設/強化', modeDemolish:'🧨 撤去',     btnLang:'🌐 日本語',  btnDex:'📖 図鑑', btnShop:'🛒 店',   btnRoster:'🎒 隊列', btnFriend:'🤝 友達', btnSettings:'⚙️ 設定', btnCancel:'🚫 取消', btnExpand:'📜 拡張',  shopTitle:'ブティック', buy:'購入', msgUnlock:'✨ 解放！', timeAuto:'🕐 自動', timeDay:'☀️ 昼', timeNight:'🌙 夜' },
    'ko':    { acorns:'도토리',  gems:'영석',   lvl:'보스 Lv', modeBuild:'🔨 건설/강화', modeDemolish:'🧨 철거',     btnLang:'🌐 한국어',  btnDex:'📖 도감', btnShop:'🛒 상점', btnRoster:'🎒 로스터', btnFriend:'🤝 친구', btnSettings:'⚙️ 설정', btnCancel:'🚫 취소', btnExpand:'📜 영지구매', shopTitle:'부티크', buy:'구매', msgUnlock:'✨ 해제!', timeAuto:'🕐 자동', timeDay:'☀️ 낮', timeNight:'🌙 밤' },
    'en':    { acorns:'Acorns',  gems:'Gems',   lvl:'Boss Lv', modeBuild:'🔨 Build/Up',  modeDemolish:'🧨 Demolish', btnLang:'🌐 English', btnDex:'📖 Dex',   btnShop:'🛒 Shop', btnRoster:'🎒 Roster', btnFriend:'🤝 Friend', btnSettings:'⚙️ Settings', btnCancel:'🚫 Cancel', btnExpand:'📜 Expand', shopTitle:'Boutique', buy:'Buy', msgUnlock:'✨ Unlocked!', timeAuto:'🕐 Auto', timeDay:'☀️ Day', timeNight:'🌙 Night' },
    'es':    { acorns:'Bellotas',gems:'Gemas',  lvl:'Nivel',   modeBuild:'🔨 Construir',  modeDemolish:'🧨 Demoler',  btnLang:'🌐 Español', btnDex:'📖 Códice',btnShop:'🛒 Tienda',btnRoster:'🎒 Equipo',btnFriend:'🤝 Amigo', btnSettings:'⚙️ Ajustes', btnCancel:'🚫 Cancelar', btnExpand:'📜 Expandir', shopTitle:'Boutique', buy:'Comprar', msgUnlock:'✨ ¡Desbloqueado!', timeAuto:'🕐 Auto', timeDay:'☀️ Día', timeNight:'🌙 Noche' }
};
